import './style.css';
const PROFILE = {"day":"Day072","title":"Travel Socket Map","display_name_ja":"旅先コンセント地図","one_sentence":"宿泊先で使う機器を、必要なコンセント数に並べるツール","purpose_line_ja":"旅先の充電セットを決めるためのツールです。","use_case_line_ja":"旅行前夜に充電器を詰める前に使います。","how_it_works_line_ja":"機器と口数を入れると、必要な束が出ます。","core_action":"plug_match","family":"travel_socket_layout","mechanic":"plug_match","input_style":"device_slots","output_style":"device_bundle","output_label":"ここを見ればOKです","audience_promise":"充電まわりの不足を荷造り前に潰せる。","publish_hook":"機器と必要口数を入れると、足りない口数と持つべきケーブル束が一画面で見える。","engine":"brief_driven","interaction_archetype":"plug_match","page_archetype":"cable_tray","ui_variant":"cable","intro_variant":"device_bundle","interaction_model":"toggle_devices_to_needed_accessories","primary_layout":"device_strip_with_accessory_tray","result_presentation_style":"required_vs_extra_accessories","palette_motif":"ガジェットスチール","main_cta":"持ち出す端末で試す","input_panel_title":"持ち出す端末を選ぶ","sample_panel_title":"持ち出す端末で試す","guide_panel_title":"充電セットの見どころ","hero_panel_label":"今日持つ充電器","output_shape":"cable_tray","state_model":"plug_match_state","core_loop":"device_slots -> plug_match -> device_bundle","component_pack":"cable_tray+device_bundle","scaffold_id":"brief_canvas","single_shot_text_generator":false};
