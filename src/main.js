import './style.css';
const PROFILE = {"day":"Day072","title":"Travel Socket Map","display_name_ja":"旅先コンセント地図","one_sentence":"宿泊先で使う機器を、必要なコンセント数に並べるツール","purpose_line_ja":"旅先の充電セットを決めるためのツールです。","use_case_line_ja":"旅行前夜に充電器を詰める前に使います。","how_it_works_line_ja":"機器と口数を入れると、必要な束が出ます。","core_action":"plug_match","family":"travel_socket_layout","mechanic":"plug_match","input_style":"device_slots","output_style":"device_bundle","output_label":"ここを見ればOKです","audience_promise":"充電まわりの不足を荷造り前に潰せる。","publish_hook":"機器と必要口数を入れると、足りない口数と持つべきケーブル束が一画面で見える。","engine":"brief_driven","interaction_archetype":"plug_match","page_archetype":"cable_tray","ui_variant":"cable","intro_variant":"travel_socket_map","interaction_model":"editable_devices_to_socket_bundle","primary_layout":"device_editor_with_socket_shortage_card","result_presentation_style":"socket_lanes_and_cable_bundle","palette_motif":"旅先コンセントスチール","main_cta":"旅行前夜の充電セットで試す","input_panel_title":"機器と必要口数を足す","sample_panel_title":"旅行前夜の充電セットで試す","guide_panel_title":"足りない口の見どころ","hero_panel_label":"持っていく充電の束","output_shape":"cable_tray","state_model":"plug_match_state","core_loop":"device_slots -> plug_match -> device_bundle","component_pack":"cable_tray+device_bundle","scaffold_id":"brief_canvas","single_shot_text_generator":false};
